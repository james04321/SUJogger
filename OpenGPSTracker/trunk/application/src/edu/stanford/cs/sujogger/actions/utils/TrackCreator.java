		...
		public void onReceive(Context context, Intent intent) {
			...
			try {
				...
				while ((appResponse = mGamingServiceConn.getNextPendingNotification()) != null) {
					...
					Log.d(TAG, "TrackCreatorReceiver: Response received with request id:" + appResponse.request_id);
					Obj obj = (Obj) appResponse.object;
					switch(appResponse.request_id) {
					case 110:
						SAXParser saxParser = SAXParserFactory.newInstance().newSAXParser();
						Log.d(TAG, "OBJECT IS: " + appResponse.object.getClass().getName());
						ObjProperty[] objProp = ((Obj) appResponse.object).object_properties;
...
//			mTrackId = new Long( newTrack.getLastPathSegment() ).longValue();
		   ...
		   private void startNewSegment()
		   {
		      ...
		      Uri newSegment = mContext.getContentResolver().insert( Uri.withAppendedPath( Tracks.CONTENT_URI, mTrackId + "/segments" ), null );
