...
public class AchievementsActivity extends ListActivity {
	...
	private void fillData() {		
		...
		// Difficulty section
		groupedAdapter.addSection("Difficulty", new SimpleAdapter(this, diffItems,
				R.layout.achievementcatitem, new String[] { ITEM_TITLE, ITEM_FRACTION }, new int[] {
						R.id.achievementcat_name, R.id.achievementcat_fraction }));

		// Type section
		groupedAdapter.addSection("Type", new SimpleAdapter(this, typeItems,
				R.layout.achievementcatitem, new String[] { ITEM_TITLE, ITEM_FRACTION }, new int[] {
						R.id.achievementcat_name, R.id.achievementcat_fraction }));

		// Extended section
		groupedAdapter.addSection("Extended", new SimpleAdapter(this, extItems,
				R.layout.achievementcatitem, new String[] { ITEM_TITLE, ITEM_FRACTION }, new int[] {
						R.id.achievementcat_name, R.id.achievementcat_fraction }));
